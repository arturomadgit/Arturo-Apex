trigger LeadingCompetitor3 on Opportunity (before update, before insert) {
    for(Opportunity opp : Trigger.new){
        ...
        opp.Most_Expensive_Competitor__c = competitors.get(highestPricePosition) + ' ' + highestPrice;
    }
